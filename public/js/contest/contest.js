...
$(document).ready(function () {
  ...
  $(".btn-submit-answer").on("click", function (e) {
    e.preventDefault();
    if ($("input[name='answer']").length && $("input[name='answer']:checked").length) {
      var parent = $("input[name='answer']:checked").parent();
  ...
  function loadAnswer() {
    axios.get(LOAD_QA_ROUTE, {
      ...
      if (res.status == 200) {
        ...
        $(".btn-submit-answer").removeClass("d-none").removeClass("disabled");
